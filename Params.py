...
# 调一下参数
	...
	parser.add_argument('--dataset', default='retail_rocket', type=str, help='name of dataset')
	parser.add_argument('--point', default='for_meta_hidden_dim', type=str, help='')
	parser.add_argument('--title', default='heatmap', type=str, help='title of model')
	...
	parser.add_argument('--SSL_batch', default=10, type=int, help='batch size')
	...
	parser.add_argument('--seed', type=int, default=19990210)
	parser.add_argument('--slope', type=float, default=0.1)
	parser.add_argument('--patience', type=int, default=5)
	parser.add_argument('--test_batch', default=8192, type=int, help='test_batch size')
	#for save and read
	parser.add_argument('--path', default='/home/ssx/ColM/data/', type=str, help='data path')
	parser.add_argument('--save_path', default='/data/ssx/', help='file name to save model and training record')
	...
	parser.add_argument('--loadModelPath', default="/data/ssx/tmall/for_meta_hidden_dim_dim__64_tmall_2024_08_08__22_42_49_lr_0.0003_reg_0.001_batch_size_8192_gnn_layer_[64,64,64].pth", type=str, help='loadModelPath')
	...
	parser.add_argument('--hidden_dim_meta', default=32, type=int, help='embedding size')
